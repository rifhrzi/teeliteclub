...
export const MaintenanceWaitlistForm = ({
  ...
  className={cn(
    "w-full mx-auto flex flex-col items-center gap-3",
    formClassName
  )}
>
  <div className="relative w-full">
    <Input
      ...
      required
      className={cn(
        "h-[46px] sm:h-[52px] pl-4 pr-12 text-[14px] sm:text-base bg-transparent border border-white/50 text-white placeholder:text-white/60 focus:outline-none focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white/40 rounded-sm",
        inputClassName
      )}
